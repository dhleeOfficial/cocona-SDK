...
public class CameraHandler extends Handler {
    ...
    private static final int MSG_ZOOM = 6;
    private static final int MSG_SWITCH_LENSFACING = 7;
    ...
    void setZoom()  {
        sendMessage(obtainMessage(MSG_ZOOM));
    }
    ...
    void switchLensFacing()  {
        sendMessage(obtainMessage(MSG_SWITCH_LENSFACING));
    }
        ...
        switch (msg.what) {
            ...
            case MSG_PREVIEW_STOP:
                ...
                try {
                    ...
                    removeMessages(MSG_ZOOM);
                    removeMessages(MSG_SWITCH_LENSFACING);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                thread = null;
            ...
            case MSG_ZOOM:
                ...
                break;
            case MSG_SWITCH_LENSFACING:
                if (thread != null) {
                    thread.switchLensFacing();
                }
                break;
            default:
