...
public class MediaAudioEncoder extends MediaEncoder {
    ...
    public static int SAMPLES_PER_FRAME = 1024;    // AAC, bytes/frame/channel 1024
    public static int FRAMES_PER_BUFFER = 25;    // AAC, frame/buffer/sec
    ...
    private static int[] AUDIO_SOURCES = new int[]{
